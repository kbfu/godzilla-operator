...
func (in *ChaosJob) DeepCopyInto(out *ChaosJob) {
	*out = *in
	if in.Config != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChaosJob.
func (in *ChaosJob) DeepCopy() *ChaosJob {
	if in == nil {
		return nil
	}
	out := new(ChaosJob)
